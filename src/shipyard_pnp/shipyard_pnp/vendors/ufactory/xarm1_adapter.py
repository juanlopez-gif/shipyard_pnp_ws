...
_XARM1_POSITIONS = {
    ...
    "pick_c1s2": [-1.4278, 0.7836, 1.2150, 0.0439, 0.5092, 1.7188],
    # 17_07 previous "pick_c1s2": [-1.4430, 0.8111, 1.2676, 0.0662, 0.5936, 1.7154],
    ...
    "place_laser": [-0.2757, 1.0688, 1.6842, -0.0571, 1.0222, -0.1053],
    # 17_07 previous "place_laser": [-0.2623, 1.1955, 1.8083, -0.0585, 1.1387, -0.0832],
    "approach_laser_pick": [-0.2425, 1.0884, 1.8137, 0.0470, 0.6531, -0.4516],
    "pick_laser": [-0.2417, 1.4584, 2.2264, 0.0727, 0.8466, 1.0912],
    # 17_07 previous "pick_laser": [-0.2641, 1.3856, 2.0659, 0.1741, 0.6751, -0.6105],
    ...
    "place_c2s1": [0.8055, 0.8932, 1.4554, -0.1066, 0.5124, -0.8926],
